"""
Django settings for DifferentOdds project.
...
ROOT_URLCONF = 'DifferentOdds.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'esports.context_processor.total_esport_counts',
                'soccer.context_processor.total_soccer_counts',
            ],
        },
    },
]

WSGI_APPLICATION = 'DifferentOdds.wsgi.application'
